...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("MZ.png"));
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("flower.wav"));
	...
	showScaryImage("Flower.jpg"); 
	
	JOptionPane.showMessageDialog(null,"FILE 1 SAVED ");
	System.exit(0);
	}
